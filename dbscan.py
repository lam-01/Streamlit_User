    ...
    with tab2:
        ...
        try:
            ...
            if selected_tab == "K-means":
                ...
                # DBSCAN parameters
                eps = st.slider("Epsilon (bán kính vùng lân cận)", min_value=0.1, max_value=10.0, value=5.0, step=0.1,help=""" **Epsilon** : Bán kính để xác định khu vực lân cận của một điểm.
                ...
                \n- Nếu eps quá nhỏ(0.1-2), thuật toán có thể tạo quá nhiều cụm nhỏ hoặc không tìm thấy cụm nào.
                 """)
                min_samples = st.slider("Min Samples (số lượng mẫu tối thiểu)", min_value=2, max_value=50, value=10,help=""" **MinPts** : Số lượng điểm tối thiểu cần thiết để một khu vực được coi là đủ mật độ.
